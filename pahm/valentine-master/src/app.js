...
export default class App extends React.Component {
    ...
    fullStyle = [
        `/*
* Hi。bạn yêu！
* Đã lâu lắm rồi. Mình vẫn chưa kể cho bạn biết về công việc của mình.！
* Mình là một một người làm thiết kế, công việc của mình không liên quan nhiều đến phát triển website.
...
/* Đầu tiên, hãy thêm hiệu ứng chuyển tiếp cho tất cả các phần tử. */
* {
  -webkit-transition: all .5s;
  transition: all .5s;
}
/* Nền trắng quá đơn điệu. Hãy thêm một vài chi tiết trang trí vào nhé. */
body, html {
  color: #fff;
  background-color: darkslategray;
}

/* Văn bản quá sát nhau. */
.styleEditor {
  overflow: auto;
  ${ isPc ? `width: 48vw;
...
/* Các mã này đều có cùng màu. Hãy thêm phần tô sáng để phân biệt chúng. */
...
/*
* Bạn yêu, hôm nay Mình sẽ dạy bạn viết code đơn giản nhé.
* Code vẽ một trái tim đơn giản :>
* Không có gì đặc biệt cho lắm nhưng mà nhanh lắm :> 
* Hehe :D
*/

/* B1. chuẩn bị một trang  :> */
.heartWrapper {
  ${ isPc ? `width: 48vw;
  height: 96vh;` : `width: 96vw;
  height: 48vh;`}
...
/* Chán quá, làm sao để tim chúng ta đập nhanh hơn nào */
@keyframes throb {
  0% {
...
/*
* Xong rồi！
* À quên mất, chúc bạn có ngày mới vui vẻ :P 
*/
